...
var Frame = function (_Event) {
    inherits(Frame, _Event);

    function Frame(data, type, fps, canvas) {
        classCallCheck(this, Frame);

        var _this = possibleConstructorReturn(this, (Frame.__proto__ || Object.getPrototypeOf(Frame)).call(this));
