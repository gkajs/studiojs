...
var Material = function (_Event) {
    ...
    function Material(track, id) {
        var material = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        ...
        _this.animation = Material.formateAni(_this.material.animation || []);
        _this.animations = Material.formateAniObj(_this.material.animations || {});
